...
[![Build Status](https://travis-ci.org/fastfoxcom/hound.svg?branch=master)](https://travis-ci.org/fastfoxcom/hound) 
...
```
go get github.com/fastfoxcom/hound/cmds/...
```
...
```
git clone https://github.com/fastfoxcom/hound.git ${GOPATH}/src/github.com/fastfoxcom/hound
cd ${GOPATH}/src/github.com/fastfoxcom/hound
make
```

If this is your only Go project, you can set your GOPATH just for Hound:
```
git clone https://github.com/fastfoxcom/hound.git src/github.com/fastfoxcom/hound
GOPATH=$(pwd) make -C src/github.com/fastfoxcom/hound
```
